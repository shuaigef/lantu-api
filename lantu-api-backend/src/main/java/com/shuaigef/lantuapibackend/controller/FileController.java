...
import com.shuaigef.lantuapibackend.manager.CosManager;
import com.shuaigef.lantuapibackend.model.dto.file.UploadFileRequest;
import com.shuaigef.lantuapibackend.model.enums.FileUploadBizEnum;
...
public class FileController {
    ...
    public BaseResponse<String> uploadFile(@RequestPart("file") MultipartFile multipartFile,
        ...
        if (fileUploadBizEnum == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "文件上传业务类型错误");
        }
